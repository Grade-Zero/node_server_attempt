...
export class AuthenticationController extends Controller {
    ...
    public async Login(
        ...
        let resCookie = cookie.serialize('fusion_ordering_session', String(data.session.id), {
            path: '/',
            httpOnly: true,
    ...
    @Get('valid_session')
    @Tags('Authenticated')
    @Security('fusion_ordering_session')
    ...
    public async Logout(
        ...
        let resCookie = cookie.serialize('fusion_ordering_session', 'deleted', {
            path: '/',
            httpOnly: true,
